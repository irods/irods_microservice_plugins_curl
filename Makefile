...
MSI_CURL_DELETE		= microservices/msiCurlDelete
MSI_CURL_POST		= microservices/msiCurlPost
MSI_CURL_PUT		= microservices/msiCurlPut

MAKEFLAGS += --no-print-directory

LIBS = $(MS_PLUGIN_CURL_CORE) $(MSI_CURL_GET_OBJ) $(MSI_CURL_GET_STR) $(MSI_CURL_DELETE) $(MSI_CURL_POST) $(MSI_CURL_PUT)
...
$(MSI_CURL_DELETE): $(MS_PLUGIN_CURL_CORE)
